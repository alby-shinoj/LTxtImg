...
if __name__ == "__main__":
	...
	cprint(figlet_format('LTxtImg!', font='starwars'),'yellow', attrs=['bold'])
	print()
	print("[bold]LTxtImg[/bold] allows you to hide texts inside an image. You can also protect these texts with a password using AES-256.")
	print()
